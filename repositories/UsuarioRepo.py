...
class UsuarioRepo:
    @classmethod
    def criar_tabela(cls) -> bool or False: # type: ignore
        try:
    ...
    @classmethod
    def criar_administrador_padrao(cls) -> bool or False: # type: ignore
        try:
            with criar_conexao() as conexao:
                cursor = conexao.cursor()
    ...
    @classmethod
    def criar_usuario_padrao(cls) -> bool or False: # type: ignore
        try:
            with criar_conexao() as conexao:
                cursor = conexao.cursor()
    ...
    @classmethod
    def alterar(cls, usuario: Usuario) -> bool or False: # type: ignore
        with criar_conexao() as conexao:
            cursor = conexao.cursor()
            cursor.execute(
    ...
    @classmethod
    def alterar_token_por_email(cls, token: str, email: str) -> bool or False: # type: ignore
        with criar_conexao() as conexao:
            cursor = conexao.cursor()
    ...
    @classmethod
    def existe_email(cls, email: str) -> bool or False: # type: ignore
        with criar_conexao() as conexao:
            cursor = conexao.cursor()
    ...
    @classmethod
    def alterar_senha(cls, usuario: Usuario) -> bool or False: # type: ignore
        with criar_conexao() as conexao:
            cursor = conexao.cursor()
